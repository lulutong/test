...
public class EsmartWorkOrderV4Po implements java.io.Serializable{
    ...
    /**
     * 提前统筹标识 0-非提前统筹 1-提前统筹       db_column: advance_assign_flag   
     */ 	
	private Integer advanceAssignFlag;
	//columns END
	...
	public void setInventoryState(Integer value) {
		this.inventoryState = value;
	}
	
	
	public Integer getAdvanceAssignFlag() {
		return this.advanceAssignFlag;
	}
	
	public void setAdvanceAssignFlag(Integer value) {
		this.advanceAssignFlag = value;
	}
