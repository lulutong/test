...
public class EsmartGrabOrderPoolPo implements Serializable {
	private static final long serialVersionUID = 1L;
	//alias
	public static final String TABLE_ALIAS = "EsmartGrabOrderPool";
    ...
    /**
     * 0-未付款 1-未抢单 2-已抢单 3-已取消 4-已完成       db_column: grab_order_status   
     */ 	
    ...
    /**
     * 自动取消结束时间       db_column: grab_order_end_time   
     */ 	
	private java.util.Date grabOrderEndTime;
    /**
     * 非熟识者抢单广播推送时间(针对B端后置支付下单、前置支付、拒单、派单、抢单时重置)       db_column: server_push_time   
     */ 	
	private java.util.Date serverPushTime;
	//columns END
	...
	public java.util.Date getGrabOrderEndTime() {
		return this.grabOrderEndTime;
	}
	
	public void setGrabOrderEndTime(java.util.Date value) {
		this.grabOrderEndTime = value;
	}
	
	
	public java.util.Date getServerPushTime() {
		return this.serverPushTime;
	}
	
	public void setServerPushTime(java.util.Date value) {
		this.serverPushTime = value;
	}
