...
public class EsmartEmpCommunityRelPo implements java.io.Serializable{
	private static final long serialVersionUID = 1L;
	//alias
	public static final String TABLE_ALIAS = "EsmartEmpCommunityRel";
	

	//columns START
    /**
     * 员工收藏小区ID       db_column: emp_community_rel_id   
     */ 	
	private Integer empCommunityRelId;
    /**
     * 员工ID       db_column: emp_id   
     */ 	
	private Integer empId;
    /**
     * 小区ID       db_column: community_id   
     */ 	
	...
	public Integer getEmpCommunityRelId() {
		return this.empCommunityRelId;
	}
	
	public void setEmpCommunityRelId(Integer value) {
		this.empCommunityRelId = value;
	}
