...
public class LogAspect {
    ...
    @Pointcut("(execution(* com.ecej.esmart..service.commons..*(..)) || execution(* com.ecej.esmart..service.impl..*(..))|| execution(* com.ecej.esmart..queue..*(..))) " +
            "&& !execution(* com.ecej.esmart.autodispatch..*(..))")
